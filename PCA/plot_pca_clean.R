...
# PC1 vs PC2
world_pc12 <- ggplot(world_pca_reg, aes(PC1, PC2, colour=global_region,shape=collection_3_levels)) + geom_point(size=3) + theme_classic(base_size = 14)+
  theme(panel.border = element_rect(colour = "black", fill=NA, linewidth = 1))+
...
# PC1 vs PC3
world_pc13 <- ggplot(world_pca_reg, aes(PC1, PC3, colour=global_region,shape=collection_3_levels)) + geom_point(size=3) + theme_classic(base_size = 14)+
  theme(panel.border = element_rect(colour = "black", fill=NA, linewidth = 1))+
  labs (x = paste("PC1", " ", "(", signif(world_eig$var_perc[1], 3),"%", ")",  sep = ""), 
...
#PC2 vs PC3
world_pc23 <- ggplot(world_pca_reg, aes(PC2, PC3, colour=global_region,shape=collection_3_levels)) + geom_point(size=3) + theme_classic(base_size = 14)+
  theme(panel.border = element_rect(colour = "black", fill=NA, linewidth = 1))+
