...
setwd("~/projects/project_bgt_popgen/analysis/rda/host/")
...
model_names <- c("Full model", "Climate", "Wind", "Geography", "Country", "Host",
...
pRDA_models <- readRDS(file="output/pRDA_models.Rds")
...
anova_results <- readRDS(file="output/anova_list_new.Rds")
...
write.csv(varpar_table, file="output/table_variance_partitioning.csv", na = " ")

#wind_t <- read.csv("../clim/output/table_variance_partitioning.csv")
